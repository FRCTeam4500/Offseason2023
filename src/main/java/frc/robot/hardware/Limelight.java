...
public class Limelight {
  ...
  public double getTargetArea() { return getEntry("ta"); }
  ...
  public void setPipeline(int index) { setEntry("pipeline", index); }
  ...
  public Pose3d getRobotPoseToField() {
    ...
    return new Pose3d(raw[0], raw[1], raw[2],
  ...
  public Pose3d getRobotPoseToTarget() {
    double[] raw =
        table.getEntry("botpose_targetspace").getDoubleArray(new double[6]);
    return new Pose3d(raw[0], raw[1], raw[2],
                      new Rotation3d(raw[3], raw[4], raw[5]));
  }
