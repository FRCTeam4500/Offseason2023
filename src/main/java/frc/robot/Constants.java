...
public class Constants {
  ...
  public static class SwerveConstants {
    ...
    public static final double MAX_LINEAR_SPEED =
        ((1276 * 9.42) / 60) / 12 *
        0.3048; // 1276 is rpm, 9.42 is wheel circumference (in.), final units
                // are m/s
    public static final double MAX_LINEAR_ACCELERATION = 4; // Test
    public static final double MAX_ROTATIONAL_SPEED =
        MAX_LINEAR_SPEED / (4 / 3); // 4/3 is (about) the radius from the center
                                    // of the robot to the swerve drive wheels.
    public static final double MAX_ROTATIONAL_ACCELERATION =
        4; // Linear Acceleration/radius

    public static final double DRIVE_RATIO =
        1 / 5.; // drive rotations per motor rotation
    public static final double ANGLE_RATIO =
    ...
    public static final Translation2d FRONT_LEFT_MODULE_TRANSLATION =
        new Translation2d(0.3175, 0.2413);
  ...
  public static class ArmConstants {
    ...
    /**
     * The angle of the arm to remove the latch holding it up when a match
     * starts
     */
  ...
  public static class EnumConstants {
    ...
    public static enum ArmPosition {
      Start(ArmConstants.ZERO_EXTENSION, ArmConstants.START_ANGLE,
            IntakeConstants.ZERO_ANGLE),
      Zero(ArmConstants.ZERO_EXTENSION, ArmConstants.ZERO_ANGLE,
           IntakeConstants.ZERO_ANGLE),
      Bot(ArmConstants.GROUND_EXTENSION, ArmConstants.GROUND_ANGLE,
          IntakeConstants.GROUND_ANGLE),
      Mid(ArmConstants.MIDDLE_EXTENSION, ArmConstants.MID_ANGLE,
          IntakeConstants.MIDDLE_ANGLE),
      Top(ArmConstants.HIGH_EXTENSION, ArmConstants.PLACE_ANGLE,
          IntakeConstants.TOP_ANGLE),
      Sub(ArmConstants.SUBSTATION_EXTENSION, ArmConstants.SUBSTATION_ANGLE,
          IntakeConstants.SUBSTATION_ANGLE),
      TELEOP_MOVING(ArmConstants.ZERO_EXTENSION,
      ...
      private ArmPosition(double armExtension, double armAngle,
                          double intakeAngle) {
    ...
    public static enum IntakeMode {
      ...
      Place(0.0,
            GamePiece.Nothing), // The value for place doesn't matter, since
                                // that is decided by which game piece we have
      Off(0.0, null);
    ...
    public static enum TalonType {
      ...
      private TalonType(String model) { this.model = model; }
    }
  }
