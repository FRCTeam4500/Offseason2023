...
public class ChassisAccel {
	...
	public ChassisAccel(
		...
		ChassisSpeeds oldSpeed,
		double time
	) {
		this.ax =
			(newSpeed.vxMetersPerSecond - oldSpeed.vxMetersPerSecond) / time;
		this.ay =
			(newSpeed.vyMetersPerSecond - oldSpeed.vyMetersPerSecond) / time;
		this.alpha =
			(newSpeed.omegaRadiansPerSecond - oldSpeed.omegaRadiansPerSecond) /
			time;
