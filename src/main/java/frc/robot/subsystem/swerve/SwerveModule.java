...
public class SwerveModule {
    ...
    public void drive(SwerveModuleState initialTargetState) {
        ...
        setModuleVelocity(targetState.speedMetersPerSecond * Math.abs(targetState.angle.minus(getModuleState().angle).getCos())); 
    ...
    public void setModuleVelocity(double targetVelocity) {
        driveMotor.setAngularVelocity(targetVelocity * 2 / (SwerveConstants.DRIVE_RATIO * SwerveConstants.WHEEL_DIAMETER));
    }
