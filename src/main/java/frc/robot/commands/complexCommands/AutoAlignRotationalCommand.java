...
public class AutoAlignRotationalCommand extends CommandBase{
    ...
    private int rotationalThreshold;
    private int timesCorrect;
    public AutoAlignRotationalCommand(int limelightId, int timeThreshold, int rotationThreshold) {
    ...
    @Override
    public void execute() {
        double horizontalAngleOffset = Units.radiansToDegrees(vision.getHorizontalAngleOffset(limelightId));
        swerve.driveRobotCentric(0, 0, pid.calculate(horizontalAngleOffset)/10);
