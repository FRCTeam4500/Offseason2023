...
public class EstimatorStrat {
     ...
     *                                 these numbers to trust your
     *                                 model's state estimates less. This matrix is
     *                                 in the form [x, y, theta]ᵀ, with units in
     *                                 meters and radians.
     * @param localMeasurementStdDevs  Standard deviations of the encoder and gyro
     *                                 measurements.
     *                                 Increase these numbers to trust sensor
     *                                 readings from encoders and gyros less. This
     *                                 matrix
     *                                 is in the form [theta], with units in
     *                                 radians.
     ...
     *                              should use
     *                              Timer.getFPGATimestamp as your time source or
     *                              sync the epochs.
     */
     ...
     *                                 Timer.getFPGATimestamp.) This means that you
     *                                 should use
     *                                 Timer.getFPGATimestamp as your time source in
     *                                 this case.
     * @param visionMeasurementStdDevs Standard deviations of the vision
     *                                 measurements. Increase these
     *                                 numbers to trust global measurements from
