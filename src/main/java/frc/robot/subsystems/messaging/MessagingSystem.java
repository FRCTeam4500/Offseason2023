...
public class MessagingSystem
    extends SubsystemBase implements MessagingSystemInterface {
  private static MessagingSystem systemInstance;
  private String message;
  private String newestMessage;
  private boolean isEnabled = false;

  private MessagingSystemInputsAutoLogged inputs =
      new MessagingSystemInputsAutoLogged();

  public MessagingSystemInputsAutoLogged getInputs() { return inputs; }
  ...
  public void enableMessaging(boolean enable) { isEnabled = enable; }

  public void enableMessaging() { isEnabled = true; }
