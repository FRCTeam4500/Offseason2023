...
public class Arm extends SubsystemBase implements ArmInterface {
  ...
  public ArmInputsAutoLogged getInputs() { return inputs; }

  private Arm() {
    angleMotor = new SparkMaxMotorController(ArmConstants.ANGLE_MOTOR_ID,
                                             MotorType.kBrushless);
    extensionMotor = new TalonMotorController(ArmConstants.EXTENSION_MOTOR_ID,
                                              TalonType.TalonSRX);
  ...
  public void changeAngle(double addition) { setAngle(targetAngle + addition); }

  public double getAngle() { return angleMotor.getAngle(); }

  private double getTargetAngle() { return targetAngle; }
  ...
  public double getExtension() { return extensionMotor.getAngle(); }

  private double getTargetExtension() { return targetExtension; }
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty(
        "Target Extension: ", () -> getTargetExtension(), null);
    builder.addDoubleProperty("Current Angle: ", () -> getAngle(), null);
    builder.addDoubleProperty(
        "Current Extension: ", () -> getExtension(), null);
  }
}
