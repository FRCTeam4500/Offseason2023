...
public class OperatorController extends CommandJoystick {
	...
	private final Trigger coneButton = this.button(JoystickConstants.CONE_INTAKE);
	...
	private final Trigger tiltUpButton = this.button(JoystickConstants.TILT_INTAKE_UP);
	private final Trigger tiltDownButton = this.button(JoystickConstants.TILT_INTAKE_DOWN);
	...
	public void addToShuffleBoard() {
		...
		Shuffleboard.getTab("Arm and Intake").addString("Current Game Piece", () -> Intake.getGamePiece().name());
	}
}
