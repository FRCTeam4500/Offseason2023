...
//import frc.robot.subsystems.swerve.pathfollowingswerve.PathFollowingSwerve;
...
public class ExtendedTrajectoryUtilities {
	...
	private static Trajectory getDeployedTrajectoryExcept(
	...
	public static Trajectory regenerateTrajectory(
	...
	public static HolonomicDriveController createBasicController(
		double kPx,
		double kPy,
		double kPw,
		double maxRotationalSpeed,
		double maxRotationlAcceleration
	) {
