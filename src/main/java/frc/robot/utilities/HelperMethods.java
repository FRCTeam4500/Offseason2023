...
public class HelperMethods {
   ...
   * that are 2 pi away from each other are equivalent.
   *
   ...
   */
  public static double getShortestRadianToTarget(double currentAngle,
                                                 double targetAngle) {
   ...
   * certain threshold <p> This is useful since in most cases, the robot's pose
   * will not exactly match a target pose, but rather get very close to it.
   ...
   */
  public static boolean isClose(Pose2d pose1, Pose2d pose2,
  ...
  public static Twist2d log(final Pose2d transform) {
    ...
    return new Twist2d(translation_part.getX(), translation_part.getY(),
                       dtheta);
  }
}
